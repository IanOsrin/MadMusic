...
export const JS_MODULES = [
  ...
  'js/mobile/auth.js', 'js/mobile/nav.js', 'js/mobile/search.js', 'js/mobile/playlists.js',
  'js/mobile/cards.js', 'js/mobile/player.js',
  'js/mobile/rails-newreleases.js', 'js/mobile/rails-g100.js', 'js/mobile/rails-discover.js',
];
