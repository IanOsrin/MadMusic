...
if (record) {
  ...
  console.log('Music Sounds Of Africa - Full Details:');
  console.log('  Album:', fields['Tape Files::Album Title']);
  console.log('  Featured:', fields['Tape Files::Featured']);
  console.log('  Visibility:', fields['Visibility'] || fields['Tape Files::Visibility']);
  console.log('  Artwork S3:', fields['Tape Files::Artwork_S3_URL']);
  console.log('  S3_URL (audio):', fields['S3_URL']);
  console.log('  Has GMVi artwork?:', (fields['Tape Files::Artwork_S3_URL'] || '').toLowerCase().includes('gmvi'));
  console.log('  Has audio?:', !!(fields['S3_URL'] || '').trim());
}
