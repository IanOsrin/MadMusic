...
import { DECADES, GENRES } from './data.js?v=5';
import { state } from './state.js?v=5';
import { loadPlaylists } from './playlists.js?v=5';
import { loadDiscover } from './rails-discover.js?v=5';
import { loadG100, loadG100Playlists, loadScenes } from './rails-g100.js?v=5';
import { loadNewReleases } from './rails-newreleases.js?v=5';
import { pushTab, isRestoring } from './router.js?v=5';
