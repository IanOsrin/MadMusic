...
import { DECADES, GENRES } from './data.js?v=13';
import { state } from './state.js?v=13';
import { loadPlaylists } from './playlists.js?v=13';
import { loadDiscover } from './rails-discover.js?v=13';
import { loadG100, loadG100Playlists, loadScenes } from './rails-g100.js?v=13';
import { loadNewReleases } from './rails-newreleases.js?v=13';
import { pushTab, isRestoring } from './router.js?v=13';
