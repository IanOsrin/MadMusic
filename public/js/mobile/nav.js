...
import { DECADES, GENRES } from './data.js?v=15';
import { state } from './state.js?v=15';
import { loadPlaylists } from './playlists.js?v=15';
import { loadDiscover } from './rails-discover.js?v=15';
import { loadG100, loadG100Playlists, loadScenes } from './rails-g100.js?v=15';
import { loadNewReleases } from './rails-newreleases.js?v=15';
import { pushTab, isRestoring } from './router.js?v=15';
