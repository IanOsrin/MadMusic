...
import { DECADES, GENRES } from './data.js?v=4';
import { state } from './state.js?v=4';
import { loadPlaylists } from './playlists.js?v=4';
import { loadDiscover } from './rails-discover.js?v=4';
import { loadG100, loadG100Playlists, loadScenes } from './rails-g100.js?v=4';
import { loadNewReleases } from './rails-newreleases.js?v=4';
import { pushTab, isRestoring } from './router.js?v=4';
