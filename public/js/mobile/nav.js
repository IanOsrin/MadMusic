...
import { DECADES, GENRES } from './data.js?v=21';
import { state } from './state.js?v=21';
import { loadPlaylists } from './playlists.js?v=21';
import { loadDiscover } from './rails-discover.js?v=21';
import { loadG100, loadG100Playlists, loadScenes } from './rails-g100.js?v=21';
import { loadNewReleases } from './rails-newreleases.js?v=21';
import { pushTab, isRestoring } from './router.js?v=21';
