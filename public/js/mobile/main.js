// Mobile app entry (ES module). The mobile app is being carved out of one file
// into focused modules. Leaf modules extracted so far: data, state, util, fields
// (imported below). What remains here — nav, auth, rails, search, playlists,
// cards, player, init + DOM wiring — gets carved in later phases.

import { GENRES, DECADES } from './data.js';
import { state, elements } from './state.js';
import { showToast, formatTime, generateSessionId } from './util.js';
import {
  getFieldValue, getArtworkUrl, getTitleField, getArtistField, getAlbumArtist,
  getAlbumField, getYearField, getAudioUrl, hasValidAudio, hasValidArtwork,
  groupTracksByAlbum, getGenreField,
} from './fields.js';
