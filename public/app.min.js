...
function doSearch(q, options = {}){
    ...
    async function openTracksModal(album, sourceCard=null){
      ...
      validTracks.forEach((t, idx) => {
        ...
        // Mad Mixer (dark unless MAD_MIXER_ENABLED): hidden until js/mad-mixer-links.js finds
        // this track among the MADMixer songs; it then shows it and handles the click.
        if (window.__MAD_MIXER && t.recordId) {
          const btnMix = document.createElement('button');
          btnMix.type = 'button';
          btnMix.className = 'btn small btn-mad-mixer';
          btnMix.title = 'Open this song in Mad Mixer';
          btnMix.innerHTML = '🎚 Mad Mixer';
          btnMix.dataset.mixRec = String(t.recordId);
