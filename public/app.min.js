...
function doSearch(q, options = {}){
    ...
    if (exploreGenresEl){
      const genres = ['40\'s','50\'s','60\'s','70\'s','80\'','90\'s','Acapella','Acoustic','Accordian','Adult','Adult Contemporary','Adult Contemporary (Singer/Songwriter)','African','African Dancehall','African Jazz','Afrikaans','Afro Acid Beat','Afro Beat','Afro Dancehall','Afro-Folk','Afro Fusion','Afro Gqom','Afro House','Afro Jazz','Afro Pop','Afro-Pop','Afro Rock','Afro Soul','Afro Tech','Afro Zouk','Alternative','Alternative Rock','Amapiano','Ambient','Animation','Anthem','Basotho Traditional','Big Band','Blues','BoereMusiek','Bubblegum','Children','Childrens Music','Chillout','Choral','Choir','Christian','Christmas','Classic Lounge','Classic Rock','Classical','Club Dance','Comedy','Cool Jazz','Country','Country (Contemporary)','Country (Traditional)','Cultural','Dance','Dancehall','Deep House','Disco','Diwali','Drama','Dub Step','Dubstep','Easy Listening','EDM','Electro','Electro House','Electro Pop','Electro Rock','Electronic','Electronic Dance','Folk','Folk (Singer/Songwriter)','Free Jazz','French Pop','Funk','Fusion','Garage','General','Genetone','Ghetto Zouk','Gospel','Gospel Jazz','Gqom','Halloween','Hard Rock','High Life','Hip Hop','Hip Hop Instrumental','Holiday','House','Hymn','Indie','Indie Dance','Indie Folk','Indie Rock','Inspirational','Instrumental','Islamic','Is\'cathamiya','Jazz','Jazz (Contemporary)','Jazz (Traditional)','Jazz Fusion','K Pop','Kalifah AgaNaga','Karahanyuze','Karaoke','Kids','Kizomba','Kuduro','Kwaito','Kwela','Latin','Latin Music','Live','Lounge','Mambo','Marabi','Mancala','Maskandi','Mbhaqanga','Meaning Tunes','Mgqashiyo','Modern Classical','Motswako','Music Feature Films','Musicals','MX Funk','Name Tune','New Age','New Age Kwaito','New Wave','Ndebele Traditional','Nujazz','Oldies','Other','Podcast','Pop','Pop (Singer/Songwriter)','Pop Rock','Progressive Punk','Progressive Rock','Psych Rock','Rap','Reggae','Reggaeton','Religious','Rhumba','RnB','Rock','Rockabilly','Salsa','Samba','Sax Jive','Sega','Shangaani','Shangaan Disco','Singer/Songwriter','Soukous','Soul','Soulful House','Soundtrack','Spiritual','Spoken Word','Swing Music','Tango','Tech House','Township Jive','Traditional','Trance','Trap','TrapSoul','Tsonga Disco','Tsonga Traditional','Twist','Urban','Vocal','Volksmusik','World Music','Zouk'];
...
window.massCreatePlaylist = async function() {
  const S3_BASE = 'https://mass-music-audio-files.s3.eu-north-1.amazonaws.com/artwork/';
  const TEMPLATES = [
    { name: 'Jazz',      file: 'Playlist_Jazz' },
    { name: 'Marabi',    file: 'Playlist_Marabi' },
    { name: 'Kwela',     file: 'Playlist_Kwela' },
    { name: 'Soul',      file: 'Playlist_Soul' },
    { name: 'Blues',     file: 'Playlist_Blues' },
    { name: 'Classical', file: 'Playlist_Classical' },
    { name: 'Afro',      file: 'Playlist_Afro' },
    { name: 'Chill',     file: 'Playlist_Chill' },
  ];
  ...
  TEMPLATES.forEach(({ name: tName, file }) => {
    const url = `${S3_BASE}${file}.jpg`;
    ...
    img.onerror = () => { img.src = `${S3_BASE}${file}.webp`; img.onerror = null; };
    ...
    cell.addEventListener('click', () => {
      grid.querySelectorAll('button').forEach(b => { b.style.borderColor = 'transparent'; b.style.transform = 'scale(1)'; });
      if (selectedArtwork === url) {
        selectedArtwork = '';
      } else {
        selectedArtwork = url;
        cell.style.borderColor = 'var(--accent,#8b5cf6)';
